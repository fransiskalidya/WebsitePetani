...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Beranda Admin') }}</div>
...
@include('sesudah.layouts.sidebar')
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      {{-- <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Item Sold</div> --}}
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">SELAMAT DATANG DI WEBSITE PETANIKU</div>
                        </div>
                        <div class="col">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <i class="fas fa-users fa-3x"></i>
                      <br>
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Petani</div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <i class="fas fa-boxes fa-3x"></i>
                      <br>
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Jenis Pupuk</div>
          ...
          <!-- Content Row -->
            ...
            {{-- <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <h4 class="small font-weight-bold">Urea <span class="float-right">2</span></h4>
                  <div class="progress mb-4">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <h4 class="small font-weight-bold">Za <span class="float-right">4</span></h4>
                  <div class="progress mb-4">
                    <div class="progress-bar bg-warning" role="progressbar" style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <h4 class="small font-weight-bold">Phonska <span class="float-right">6</span></h4>
                  <div class="progress mb-4">
                    <div class="progress-bar" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <h4 class="small font-weight-bold">Organik <span class="float-right">8</span></h4>
                  <div class="progress mb-4">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; PETANIKU</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
